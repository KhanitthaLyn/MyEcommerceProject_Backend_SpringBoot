...
import com.ecommerce.myecommerceproject.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<ProductResponse> getAllProducts(
            ...
            @RequestParam(name = "caregory", required = false) String caregory,
            @RequestParam(name = "pageNumber", defaultValue = AppConstants.PAGE_NUMBER, required = false) Integer pageNumber,
            @RequestParam(name = "pageSize", defaultValue = AppConstants.PAGE_SIZE, required = false) Integer pageSize,
            @RequestParam(name = "sortBy", defaultValue = AppConstants.SORT_PRODUCTS_BY, required = false) String sortBy,
            @RequestParam(name = "sortOrder", defaultValue = AppConstants.SORT_DIR, required = false) String sortOrder
    ) {
        ProductResponse productResponse = productService.getAllProducts(pageNumber, pageSize, sortBy, sortOrder, keyword,caregory);
    ...
    public ResponseEntity<ProductDTO> updateProduct(@Valid @RequestBody ProductDTO productDTO,
        ...
        ProductDTO updateProductDTP = productService.updateProduct(productId, productDTO);
        return new ResponseEntity<>(updateProductDTP, HttpStatus.OK);
    }

    @DeleteMapping("/admin/products/{productId}")
    public ResponseEntity<ProductDTO> deleteProduct(@PathVariable Long productId) {
        ProductDTO deleteProductDTP = productService.deleteProduct(productId);
        return new ResponseEntity<>(deleteProductDTP, HttpStatus.OK);
    }
